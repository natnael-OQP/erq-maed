...
const Small_Event_Card = ({number}) => {
	return (
		<div className="flex flex-col  w-[230px] h-[250px]    rounded-lg overflow-hidden">
			...
			<div className="w-full bg-gray-50 h-[35%] p-3 flex flex-col justify-center items-center relative">
				<h5 className="text-sm text-gray-500 font-semibold text-center">Removed enjoyed explain</h5>
				<h5 className="text-xs text-gray-400 font-semibold text-center mt-1">By nathan</h5>
				<div className="w-10 h-10 bg-primary absolute -top-5 left-3 rounded-full">
				</div>
			</div>
		</div>
	);
